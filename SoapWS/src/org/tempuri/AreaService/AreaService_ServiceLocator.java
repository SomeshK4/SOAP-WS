...
public class AreaService_ServiceLocator extends org.apache.axis.client.Service implements org.tempuri.AreaService.AreaService_Service {
    ...
    private java.lang.String AreaServiceSOAP_address = "http://localhost:8088/SoapWS/services/AreaServiceSOAP";
    ...
    public org.tempuri.AreaService.AreaService_PortType getAreaServiceSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            org.tempuri.AreaService.AreaServiceSOAPSoapBindingStub _stub = new org.tempuri.AreaService.AreaServiceSOAPSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (org.tempuri.AreaService.AreaService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                org.tempuri.AreaService.AreaServiceSOAPSoapBindingStub _stub = new org.tempuri.AreaService.AreaServiceSOAPSoapBindingStub(new java.net.URL(AreaServiceSOAP_address), this);
                _stub.setPortName(getAreaServiceSOAPWSDDServiceName());
                return _stub;
            }
        }
